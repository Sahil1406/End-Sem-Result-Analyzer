...
st.write("From this semester, 27 students from 36 have cleared all the Subjects.")
pass_percent = int((27/36)*100)
st.write(f"The Passing Percent of this Semester is {pass_percent}%")
...
stats_fig= px.bar(
    df,
    x="Seat No",
    y="Statistics for Artificial Intelligence & Data Science",
    orientation="v",
    title="<b>Statistics for Artificial Intelligence & Data Science</b>",
...
with col2:
    ...
    st.write(f"From this semester, {passed} number of students out of 36 have passed in Computer Network")
    percent = int((passed/36)*100)
...
with col2:
    ...
    st.write(f"From this semester, {passed} number of students out of 36 have passed in Web Computing")
    percent = int((passed/36)*100)
...
with col2:
    ...
    st.write(f"From this semester, {passed} number of students out of 36 have passed in Artificial Intelligence")
    percent = int((passed/36)*100)
...
with col2:
    ...
    st.write(f"From this semester, {passed} number of students out of 36 have passed in Data Warehousing & Mining")
    percent = int((passed/36)*100)
...
col1, col2 = st.columns(2)
with col1: 
    grades_counts = categorize_grades(df, 'Statistics for Artificial Intelligence & Data Science')
    for key, values in grades_counts.items():
        st.write(f'The number of {key} Grades in Statistics for Artificial Intelligence & Data Science is {values}')
with col2:
    passed = passPercent(df, 'Statistics for Artificial Intelligence & Data Science')
    st.write(f"From this semester, {passed} number of students out of 36 have passed in Statistics for Artificial Intelligence & Data Science")
    percent = int((passed/36)*100)
    st.write(f"Therefore, {percent}% students have cleared Statistics for Artificial Intelligence & Data Science")
